...
{
    public class TAMemberController : Controller
    {
        private readonly SailContext _context;

        public TAMemberController(SailContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["ProvinceCode"] = new SelectList(_context.Province, "ProvinceCode", "Name");
            return View();
        }

        // POST: TAMember/Create

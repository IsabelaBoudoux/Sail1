/*
 * SailContext class that provides a session with the Sail database
 * Assignment 1
 * Revision History
...
namespace TeamA.Models
{
    ...
    {
        /// <summary>
        /// Default SailContext constructor
        /// </summary>
        public SailContext()
        {
        }
        ...
        /// <summary>
        /// SailContext constructor using configuration information
        /// </summary>
        ...
        // Properties mapping models to tables in Sail database
        ...
        //This function defines models, their properties and relationships
